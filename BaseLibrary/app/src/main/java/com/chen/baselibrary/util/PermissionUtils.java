...
public class PermissionUtils {
    ...
    public static final String PERMISSION_READ_CONTONTS = Manifest.permission.READ_CONTACTS;

    private static final String[] requestPermissions = {
            PERMISSION_RECORD_AUDIO,
            PERMISSION_READ_CONTONTS,
            PERMISSION_CAMERA,
    ...
    /**
     * 如果用户拒绝了权限，并选择了【不在提醒】则弹出对话框提醒用户，该权限时什么作用需要开启
     * @param activity
     * @param requestCode
    ...
    /**
     * 权限授予结果，需要在Activity的onRequestPermissionsResult方法中执行该方法，如果获取的权限则直接调用回调方法
     * @param activity
     * @param requestCode  Need consistent with requestPermission
     * @param permissions
     * @param grantResults 与requestPermissions是同一个对象
     */
